...
class TestAdaptiveAnalyzerCreation(unittest.TestCase):
    ...
    def test_adaptive_three_prime_analyzer(self):
        ...
        analyzer = create_three_prime_analyzer_adaptive(genome_gc=0.32, stringency="moderate")
    ...
    def test_adaptive_thermodynamic_filter(self):
        ...
        filter_obj = create_thermodynamic_filter_adaptive(genome_gc=0.32, temperature=30.0)
