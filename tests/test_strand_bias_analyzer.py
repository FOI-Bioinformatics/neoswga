...
class TestStrandBiasAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.analyzer_strict = StrandBiasAnalyzer(
            max_bias_ratio=2.5, max_bias_score=0.5, max_biased_primers_fraction=0.2
        )
    ...
    def test_set_analysis_some_fail(self):
        ...
        primers_sites = {
            "BALANCED": [StrandBindingSite(i, "+", "BAL") for i in range(5)]
            ...
            "BIASED2": [StrandBindingSite(100, "+", "B2")]  # 1:10 ratio - will fail
