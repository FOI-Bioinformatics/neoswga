...
class TestFilteringFunctions(unittest.TestCase):
    ...
    def test_filter_all_pass(self):
        ...
        passing = filter_primers_by_three_prime_stability(primers, stringency="lenient")
    ...
    def test_filter_some_fail(self):
        ...
        # Note: filter_primers_by_three_prime_stability returns only passing primers
        passing = filter_primers_by_three_prime_stability(primers, stringency="strict")
    ...
    def test_filter_empty_list(self):
        ...
        # Note: filter_primers_by_three_prime_stability returns only passing primers
        passing = filter_primers_by_three_prime_stability([], stringency="moderate")
...
class TestStabilityScoreCalculation(unittest.TestCase):
    ...
    def test_better_primer_higher_score(self):
        ...
        self.assertGreater(stability_good.stability_score, stability_poor.stability_score)
