...
@pytest.mark.parametrize(
    "polymerase,expected_min_k,expected_max_k,expected_mg",
    [
        ("phi29", 6, 12, 10.0),
...
def test_polymerase_default_kmer_range_and_mg(
    tmp_path, polymerase, expected_min_k, expected_max_k, expected_mg
):
