...
class ValidationSuite:
    ...
    def run_all_tests(self) -> bool:
        ...
        for test_name, test_func in tests:
            ...
            try:
                ...
                result = ValidationResult(
                    test_name=test_name, passed=False, runtime=0, details={}, error=str(e)
                )
                self.results.append(result)
    ...
    def test_position_cache(self) -> Tuple[bool, Dict]:
        ...
        details = {"test_type": "synthetic", "num_primers": len(test_primers)}
    ...
    def test_bloom_filter(self) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            if self.verbose:
                ...
                logger.info(
                    f"False positive rate: {false_positive_rate:.1%} ({false_positives}/{len(absent_kmers)})"
                )
    ...
    def test_network_optimization(self) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            if num_components > total_sites / 2:
                details["error"] = (
                    f"Too fragmented: {num_components} components for {total_sites} sites"
                )
                return False, details
