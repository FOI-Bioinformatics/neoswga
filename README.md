...
**Requirements**: Python >= 3.13, and a k-mer counter: [KMC3](https://github.com/refresh-bio/KMC) by default, or [Jellyfish](https://www.cbcb.umd.edu/software/jellyfish/) by setting `"kmer_counter": "jellyfish"`
